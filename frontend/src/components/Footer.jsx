    ...
    return (
        <div style={{padding: "12px 0px", backgroundColor : "rgb(232, 227, 227)", textAlign: 'center', position:'fixed', width: '100%',height : '85px', bottom : '0', left: '0', right: '0', zIndex : '999'}}>
            ...
            <div className="text-center pt-1">
                <a href="https://www.linkedin.com/in/bittu-kumari-57615326a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                    <i className="bi bi-linkedin mx-2" style={{fontSize : "20px"}}></i>
                </a>

                <a href="https://www.linkedin.com/in/aakash-maurya-90847a252?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                    <i className="bi bi-linkedin mx-2" style={{fontSize : "20px"}}></i>
                </a>
                ...
                <a href="mailto:kumarib53129@gmail.com" target="_blank" rel="noreferrer">
